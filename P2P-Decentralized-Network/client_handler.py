...
# Student Name: Kevin Nunura
# Student ID: 920347620
# Student Github Username: knunura
...
class ClientHandler:
    ...
    def process_client_data(self):
        ...
        """
        while True:
            deserialized_data_from_client = self.receive()
            if not deserialized_data_from_client:
                print("No data received...")
                break
            clientid = deserialized_data_from_client['clientid']
